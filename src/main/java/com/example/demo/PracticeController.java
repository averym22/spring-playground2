...
//    public Object getJSONData(@RequestBody Flights flight) {
//
//
//
//        return flight.getTickets().get(0).getPrice() + flight.getTickets().get(1).getPrice();
//
//    }

    @PostMapping("/words/count")
    public Object getWordCount(@RequestBody String words) {
